...
print('== Files in /app/routers/ ==')
print(run('%s exec netmonitor-api ls -la /app/routers/' % DOCKER))

print('== Try importing switch directly ==')
print(run('%s exec netmonitor-api python -c "import sys; sys.path.insert(0,\'/app\'); import routers.switch as s; print(s)" 2>&1' % DOCKER))
